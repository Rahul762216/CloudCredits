...
const searchOptions = document.querySelector(
  "#search-dropdown div:nth-child(2)"
);
...
const statusUpdateNotification = document.querySelector(
    ...
    on: {
      slideChange: function () {
        ...
        const activeElement = document.querySelector(
          `.nav-items:nth-child(${activeSlideIndex + 1})`
        );
  ...
  chat.addEventListener("click", () => {
    ...
    if (screenWidth < 768) {
      ...
      function createNode() {
        ...
        e_2.setAttribute(
          "class",
          "animate__animated animate__faster md:w-2/5 dark:bg-WADarkGreen dark:text-white focus:outline-none absolute top-0 right-0 hidden w-3/5 text-black bg-white shadow-md"
        );
        ...
        e_11.setAttribute(
          "class",
          "sticky top-0 z-10 bg-WATeal dark:bg-WADarkTeal dark:text-gray-400 flex flex-col w-full p-3 text-white"
        );
        ...
        e_17.setAttribute(
          "src",
          `public/imgs/friends/${imageName}.${imageFormat}`
        );
        ...
        e_22.setAttribute(
          "src",
          "https://img.icons8.com/android/96/null/video-call.png"
        );
        ...
        e_23.setAttribute(
          "src",
          "https://img.icons8.com/material-sharp/96/000000/phone.png"
        );
        ...
        e_24.setAttribute(
          "src",
          "https://img.icons8.com/external-glyph-silhouettes-icons-papa-vector/100/null/external-Menu-interface-glyph-silhouettes-icons-papa-vector-3.png"
        );
        ...
        e_27.setAttribute(
          "class",
          "text-[8px] text-center mx-auto my-2 p-1 w-12 text-black dark:text-gray-400 bg-white dark:bg-WADarkTeal rounded-xl shadow-md"
        );
        ...
        e_28.setAttribute(
          "class",
          "text-[8px] text-center mx-auto my-2 p-2 w-80 text-black dark:text-gray-400 bg-WALightYellow dark:bg-WADarkTeal rounded-xl shadow-md"
        );
        ...
        e_30.setAttribute(
          "class",
          "fixed bottom-2 md:w-[55%] right-[2%] flex gap-1 z-10"
        ); //? how this worked, I just don't know. Lol
        var e_31 = document.createElement("div");
        e_31.setAttribute(
          "class",
          "rounded-full flex py-3 px-2 grow bg-white dark:bg-WADarkTeal drop-shadow overflow-x-hidden"
        );
        var e_32 = document.createElementNS(
        ...
        e_33.setAttribute(
          "transform",
          "translate(0.000000,457.000000) scale(0.100000,-0.100000)"
        );
        e_33.setAttribute("fill", "#000000");
        e_33.setAttribute("stroke", "none");
        var e_34 = document.createElementNS(
          "http://www.w3.org/2000/svg",
          "path"
        );
        e_34.setAttribute(
          "d",
          `M2065 4564 c-490 -51 -893 -217 -1245 -512 -666 -557 -964 -1500
        ...
        var e_35 = document.createElementNS(
          "http://www.w3.org/2000/svg",
          "path"
        );
        e_35.setAttribute(
          "d",
          `M1592 3154 c-123 -61 -202 -234 -189 -414 7 -99 29 -165 77 -236 97
        ...
        var e_36 = document.createElementNS(
          "http://www.w3.org/2000/svg",
          "path"
        );
        e_36.setAttribute(
          "d",
          `M2832 3154 c-213 -106 -261 -488 -87 -691 102 -120 272 -122 377 -5
          121 134 146 380 56 555 -72 143 -221 203 -346 141z`
        );
        e_33.appendChild(e_36);
        var e_37 = document.createElementNS(
          "http://www.w3.org/2000/svg",
          "path"
        );
        e_37.setAttribute(
          "d",
          `M1035 2023 c34 -289 152 -540 340 -728 410 -411 1158 -478 1662 -150
        ...
        e_38.setAttribute(
          "class",
          "w-4/5 bg-white dark:bg-WADarkTeal focus:outline-none caret-WATeal dark:text-white animate__animated animate__faster"
        );
        ...
        var e_40 = document.createElementNS(
          "http://www.w3.org/2000/svg",
          "svg"
        );
        ...
        var e_42 = document.createElementNS(
          "http://www.w3.org/2000/svg",
          "metadata"
        );
        ...
        var e_44 = document.createElementNS(
          "http://www.w3.org/2000/svg",
          "path"
        );
        ...
        e_49.setAttribute(
          "class",
          "rounded-full w-11 h-11 bg-WATeal relative drop-shadow"
        );
        // e_50 is created above
        e_50.setAttribute("id", "input-area-mic");
        e_50.setAttribute(
          "class",
          "w-6 h-6 absolute top-0 left-0 right-0 bottom-0 m-auto transition-[scale] duration-500 z-[1]"
        );
        ...
        var e_52 = document.createElementNS(
          "http://www.w3.org/2000/svg",
          "metadata"
        );
        ...
        var e_54 = document.createElementNS(
          "http://www.w3.org/2000/svg",
          "path"
        );
        ...
        e_54.setAttribute(
          "d",
          "M28.23 48.39c6.86,0 12.1,-5.24 12.1,-12.1l0 -24.19c0,-6.86 -5.24,-12.1 -12.1,-12.1 -6.86,0 -12.1,5.25 -12.1,12.1l0 24.19c0,6.86 5.24,12.1 12.09,12.1zm21.37 -12.1c0,12.1 -10.08,20.56 -21.37,20.56 -11.29,0 -21.37,-8.47 -21.37,-20.56l-6.86 0c0,13.71 10.89,25 24.19,27.02l0 13.31 8.07 0 0 -13.31c13.31,-2.01 24.19,-13.31 24.19,-27.02l-6.85 -0z"
        );
        // e_55 is created above
        e_55.setAttribute("id", "input-area-send-btn");
        e_55.setAttribute(
          "class",
          "w-6 h-6 absolute top-0 left-0 right-0 bottom-0 m-auto transition-[scale] scale-0 duration-500"
        );
        ...
        e_59.setAttribute(
          "points",
          "-0,284.14 331.49,142.07 -0,0 0.16,115.54 199.1,142.07 0.16,168.6 "
        );
...
neWe_2.setAttribute(
  "class",
  "p-4 w-9/12 md:max-w-[40%] lg:max-w-[30%] bg-white dark:bg-WADarkTeal md:drop-shadow-xl"
);
var neWe_3 = document.createElement("div");
neWe_3.setAttribute(
  "class",
  "text-black dark:text-white py-2 text-lg font-medium"
);
...
neWe_14.setAttribute(
  "class",
  "theme-select-btn flex text-WATeal p-2 hover:bg-gray-200 mr-3 md:px-4 cursor-pointer md:border-gray-100 dark:md:border-[#27353f] md:rounded-sm md:border-2 md:hover:bg-inherit md:transition-shadow md:duration-300 md:hover:shadow-md"
);
neWe_14.appendChild(document.createTextNode("Cancel"));
neWe_13.appendChild(neWe_14);
var neWe_15 = document.createElement("div");
neWe_15.setAttribute(
  "class",
  "theme-select-btn flex text-WATeal p-2 hover:bg-gray-200 md:px-6 md:items-center cursor-pointer md:rounded-sm md:text-white dark:md:text-WADarkTeal md:bg-WATeal md:hover:bg-WATeal md:transition-shadow md:duration-300 md:hover:shadow-md"
);
...
if (intSettingBtn !== null) {
  intSettingBtn.addEventListener("click", () => {
    function createSettingsPage() {
      ...
      e_16.setAttribute(
        "class",
        "sticky top-0 bg-WATeal dark:bg-WADarkTeal p-4 md:py-6 md:px-7 flex items-center"
      );
      ...
      e_18.setAttribute(
        "src",
        "https://img.icons8.com/android/96/null/left.png"
      );
      ...
      e_21.setAttribute(
        "class",
        "flex items-center justify-between py-5 px-6 transition duration-100 dark:bg-WADarkGreen hover:bg-gray-200 hover:dark:bg-WADarkTeal"
      );
      ...
      e_27.setAttribute(
        "class",
        "mt-1 text-gray-900 dark:text-gray-400 font-normal text-xs"
      );
      ...
      e_37.appendChild(
        document.createTextNode("Security notifications, change number")
      );
      ...
      e_44.appendChild(
        document.createTextNode("Block contact, disappearing messages")
      );
      ...
      e_48.setAttribute(
        "d",
        "M19.005,3.175H4.674C3.642,3.175,3,3.789,3,4.821V21.02 l3.544-3.514h12.461c1.033,0,2.064-1.06,2.064-2.093V4.821C21.068,3.789,20.037,3.175,19.005,3.175z M14.016,13.044H7.041V11.1 h6.975V13.044z M17.016,9.044H7.041V7.1h9.975V9.044z"
      );
      ...
      e_51.appendChild(
        document.createTextNode("Theme, wallpapers, chat history")
      );
      ...
      e_55.setAttribute(
        "d",
        "M12,21.7c0.9,0,1.7-0.8,1.7-1.7h-3.4C10.3,20.9,11.1,21.7,12,21.7z M17.6,16.5v-4.7 c0-2.7-1.8-4.8-4.3-5.4V5.8c0-0.7-0.6-1.3-1.3-1.3s-1.3,0.6-1.3,1.3v0.6C8.2,7,6.4,9.1,6.4,11.8v4.7l-1.7,1.7v0.9h14.6v-0.9 L17.6,16.5z"
      );
      ...
      var e_72 = document.createElementNS(
        "http://www.w3.org/2000/svg",
        "metadata"
      );
      ...
      e_73.setAttribute(
        "d",
        "M1.62 0.06c0.39,0.43 0.61,0.98 0.62,1.55 -0.01,0.58 -0.23,1.13 -0.62,1.55m0 -3.11c-0.39,0.43 -0.61,0.98 -0.62,1.55 0.01,0.58 0.23,1.13 0.62,1.55m0 -3.11c-0.86,0 -1.55,0.7 -1.55,1.55 0,0.86 0.7,1.55 1.55,1.55m0 -3.11c0.86,0 1.55,0.7 1.55,1.55 0,0.86 -0.7,1.55 -1.55,1.55m-1.48 -2.02l2.95 0m-2.95 0.93l2.95 0"
      );
      ...
      e_85.appendChild(
        document.createTextNode("Help centre, contact us, privacy policy")
      );
      ...
      e_98.setAttribute(
        "class",
        "flex border-b grow border-b-gray-300 dark:border-b-gray-800 py-5"
      );
      ...
      var e_103 = document.createElementNS(
        "http://www.w3.org/2000/svg",
        "path"
      );
      ...
      var e_109 = document.createElementNS(
        "http://www.w3.org/2000/svg",
        "path"
      );
      ...
      e_109.setAttribute(
        "d",
        "M12.027027,2 L4,5.56756757 L4,10.9189189 C4,15.8689189 7.42486486,20.4978378 12.027027,21.6216216 C16.6291892,20.4978378 20.0540541,15.8689189 20.0540541,10.9189189 L20.0540541,5.56756757 L12.027027,2 Z M12.027027,11.8018919 L18.2702703,11.8018919 C17.7975676,15.4764865 15.3448649,18.7497297 12.027027,19.7754054 L12.027027,11.8108108 L5.78378378,11.8108108 L5.78378378,6.72702703 L12.027027,3.95324324 L12.027027,11.8018919 Z"
      );
      ...
      var e_115 = document.createElementNS(
        "http://www.w3.org/2000/svg",
        "path"
      );
      ...
      var e_121 = document.createElementNS(
        "http://www.w3.org/2000/svg",
        "path"
      );
      ...
      var e_127 = document.createElementNS(
        "http://www.w3.org/2000/svg",
        "path"
      );
      ...
      e_127.setAttribute(
        "d",
        "M19.4725963,12.2 L15.1725963,12.2 L15.1725963,2.9 C15.1725963,2.4 14.7725963,2 14.2725963,2 L9.97259631,2 C9.47259631,2 9.07259631,2.4 9.07259631,2.9 L9.07259631,12.2 L4.77259631,12.2 C3.97259631,12.2 3.77259631,12.7 4.27259631,13.3 L11.0725963,20.6 C11.7725963,21.5 12.4725963,21.3 13.1725963,20.6 L19.9725963,13.3 C20.4725963,12.7 20.2725963,12.2 19.4725963,12.2 Z"
      );
      ...
      e_131.setAttribute(
        "class",
        "grid place-items-center pl-3 pr-6 pt-5 pb-8"
      );
      ...
      var e_133 = document.createElementNS(
        "http://www.w3.org/2000/svg",
        "path"
      );
      ...
      e_134.setAttribute(
        "class",
        "flex border-b grow border-b-gray-300 dark:border-b-gray-800 pt-5 pb-8"
      );
...
function tickLastSelectedTheme() {
  ...
  if (localStorage.getItem("theme") === "default") {
    defaultRadios
      .filter((defaultRadio) => defaultRadio !== null)
      .forEach((defaultRadioExist) => {
        defaultRadioExist.setAttribute("checked", "");
      });
  } else if (localStorage.getItem("theme") === "light") {
    lightRadios
      .filter((lightRadio) => lightRadio !== null)
      .forEach((lightRadioExist) => {
        lightRadioExist.setAttribute("checked", "");
      });
  } else if (localStorage.getItem("theme") === "dark") {
    darkRadios
      .filter((darkRadio) => darkRadio !== null)
      .forEach((darkRadioExist) => {
        darkRadioExist.setAttribute("checked", "");
      });
  }
}
...
document.addEventListener("keydown", (e) => {
  if (
    e.key === "Escape" &&
    !bgExist.forEach((modalBg) => modalBg.classList.contains("invisible"))
  ) {
    hideModal();
  }
});
